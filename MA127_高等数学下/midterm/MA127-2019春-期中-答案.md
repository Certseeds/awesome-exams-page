...
3. If $f(x, y)$ has partial derivative's $f_{x}(x, y)$ and $f_{y}(x, y)$ ot $(x_{0}, y_{0})$, then $\lim\limits_{x \rightarrow x_{0}} f(x, y_{0})=\lim\limits_{y \rightarrow y_{0}} f(x_{0}, y)=f(x_{0}, y_{0})$

$\xrightarrow{\text { True }}$ Since $f_{x}(x_{0}, y_{0})=\lim\limits_{x \rightarrow x_{0}} \frac{f(x_{1}, y_{0})-f(x_{0}, y_{0})}{x-x_{0}}=$, exist, and $\stackrel{x-x_{0} \rightarrow 0}{\Rightarrow} \lim\limits_{x \rightarrow x_{0}} f(x, y_{0})=f(x_{0}, y_{0})$

$f_{y}(x_{0}, y_{0})=\lim\limits_{y \rightarrow y_{0}} \frac{f(x_{0}, y)-f(x_{0}, y_{0})}{y-y_{0}}$ exist, and $\lim\limits_{y \rightarrow y_{0}}(y-y_{0})=0 \Rightarrow \lim\limits_{y \rightarrow y_{0}} f(x_{0}, y)=f(x_{0}, y_{0})$
...
$$
k=\frac{|f^{\prime \prime}(x)|}{(\sqrt{1+(f^{\prime}(x))^{2}})^{3}}=\frac{2}{1}=2
$$
...
(I) $\sum_{n=1}^{\infty}(-1)^{n}(1-\frac{1}{h})^{h^{2}}$

$\Rightarrow=\ln _{n \rightarrow \infty} \sqrt[n]{|a n|}=\lim\limits_{n \rightarrow \infty} \sqrt[n]{(-1)^{n}(1-\frac{1}{n})^{n^{2}}}=\lim\limits_{n \rightarrow \infty}(1-\frac{1}{n})^{n}=e^{-1}<1$
...
$\Rightarrow$ (1) $\frac{d x}{d t}=-3 \cos ^{2} t \sin t, \frac{d y}{d t}=3 \sin ^{2} t \cos t \Rightarrow(\frac{d x}{d t})^{2}+(\frac{d y}{d t})^{2}=9 \sin ^{2} t \cos ^{2} t$ $x$ axis

$$
\begin{aligned}
L & =\int_{0}^{\frac{\pi}{2}} \sqrt{(\frac{d x}{d t})^{2}+(\frac{d y}{d t})^{2}} d t=\int_{0}^{\frac{\pi}{2}} \sqrt{9 \sin ^{2} t \cos ^{2} t} d t=\int_{0}^{\frac{\pi}{2}} 3 \sin ^{2} t \cos t d t=\int_{0}^{\frac{\pi}{2}} 3 \sin t d \sin t \\
& \left.=\frac{3}{2} \sin ^{2} t\right]_{0}^{\frac{\pi}{2}}=\frac{3}{2}
\end{aligned}
$$

(2) $L=\int_{0}^{\frac{\pi}{2}} 2 \pi y \sqrt{(\frac{d(x)}{d t})^{2}+(\frac{d y}{d t})^{2}} d t=\int_{0}^{\frac{\pi}{2}} 2 \pi \sin ^{3} t \cdot 3 \sin t \cos t d t=\int_{0}^{\frac{\pi}{2}} 6 \pi \sin ^{4} t d \sin t$
...
\Rightarrow \overrightarrow{V(t)} & =(t+\frac{1}{\sqrt{3}}) \vec{i}+(2 t-\frac{1}{\sqrt{3}}) \vec{j}+(t+\frac{5}{\sqrt{3}}) \vec{k} \\
\overrightarrow{r(t)} & =\int[(t+\frac{1}{\sqrt{3}}) \vec{i}+(2 t-\frac{1}{\sqrt{3}}) \vec{j}+(t+\frac{5}{\sqrt{3}}) \vec{k}] d t \\
& =(\frac{1}{2} t^{2}+\frac{1}{\sqrt{3}} t) \vec{i}+(t^{2}-\frac{1}{\sqrt{3}} t) \vec{j}+(\frac{1}{2} t^{2}+\frac{5}{\sqrt{3}} t) \vec{k}+\vec{c} \\
\overrightarrow{V(0)} & =\vec{i}-2 \vec{k} \Rightarrow \vec{c}=\overrightarrow{r(0)}=\vec{i}-2 \vec{k} \\
\overrightarrow{F(t)} & =(\frac{1}{2} t^{2}+\frac{1}{\sqrt{3}} t+1) \vec{i}+(t^{2}-\frac{1}{\sqrt{3}} t) \vec{j}+(\frac{1}{2} t^{2}+\frac{5}{\sqrt{3}} t-2) \vec{k}
\end{aligned}
$$
...
$\Rightarrow \lim\limits_{(x, y) \rightarrow(0,0)} f(x, y)=\lim\limits_{(x, y) \rightarrow(0,0)} \frac{\sin (x^{3}+y^{3})}{x^{2}+y^{2}}=\lim\limits_{(x, y) \rightarrow(0,0)} \frac{\sin (x^{3}+y^{3})}{x^{3}+y^{3}} \cdot \frac{x^{3}+y^{3}}{x^{2}+y^{2}}=\lim\limits_{(x, y) \rightarrow(0,0)} \frac{x^{3}+y^{3}}{x^{2}+y^{2}}$

$$
=\lim\limits_{r \rightarrow 0} \frac{r^{3} \cos ^{3} \theta+r^{2} \sin ^{3} \theta}{r^{2}}=\lim\limits_{r \rightarrow 0} r(\cos ^{3} \theta+\sin ^{3} \theta)=0
$$
...
f(1)=c=0 \Rightarrow f(u)=\frac{1}{2} \ln |u|\left|f(u)=\frac{1}{2}\right| n |,
\end{array}
$$
...
$$
\begin{aligned}
& \Rightarrow f^{\prime}(x)=\frac{1+\frac{x}{\sqrt{2^{2}+1}}}{x+\sqrt{x^{2}+1}}=\frac{1}{\sqrt{x^{2}+1}}=(1+x^{2})^{-\frac{1}{2}}=1+\sum_{k=1}^{\infty}\binom{-\frac{1}{-2}}{k} x^{2 k},-1<x<1 \\
