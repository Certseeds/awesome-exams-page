...
$\Rightarrow \sum_{n=1}^{\infty} a_{n}$ converges, $a_{n}<0$ for $n>1000 \Rightarrow \sum_{n=1}^{\infty}\left|a_{n}\right|=\sum_{n=1}^{1000}\left|a_{n}\right|-\sum_{n=000}^{1000} a_{n}$ converges and $\lim _{n \rightarrow \infty} a_{n}=0$

$\therefore \lim _{n \rightarrow \infty}\left|a_{n}\right|=\lim _{n \rightarrow \infty} \frac{a_{n}^{2}}{\left|a_{n}\right|}=0, \sum\left|a_{n}\right|$ converges, $\Rightarrow \sum a_{n}^{2}$ converges. False.
...
or $2^{\circ}$. $\sum a_{n}(x-1)^{n}$ converges at $x=0 \Rightarrow \lim _{n \rightarrow \infty} a_{n}=0 \Rightarrow \exists \varepsilon=\mid$ sit $\left|a_{n}\right|<1 \quad \forall n>N$.
...
3. If $f(x, y)$ has partial derivative's $f_{x}(x, y)$ and $f_{y}(x, y)$ ot $\left(x_{0}, y_{0}\right)$, then $\lim _{x \rightarrow x_{0}} f\left(x, y_{0}\right)=\lim _{y \rightarrow y_{0}} f\left(x_{0}, y\right)=f\left(x_{0}, y_{0}\right)$.

$\xrightarrow{\text { True }}$ Since $f_{x}\left(x_{0}, y_{0}\right)=\lim _{x \rightarrow x_{0}} \frac{f\left(x_{1}, y_{0}\right)-f\left(x_{0}, y_{0}\right)}{x-x_{0}}=$, exist, and $\stackrel{x-x_{0} \rightarrow 0}{\Rightarrow} \lim _{x \rightarrow x_{0}} f\left(x, y_{0}\right)=f\left(x_{0}, y_{0}\right)$

$f_{y}\left(x_{0}, y_{0}\right)=\lim _{y \rightarrow y_{0}} \frac{f\left(x_{0}, y\right)-f\left(x_{0}, y_{0}\right)}{y-y_{0}}$ exist, and $\lim _{y \rightarrow y_{0}}\left(y-y_{0}\right)=0 \Rightarrow \lim _{y \rightarrow y_{0}} f\left(x_{0}, y\right)=f\left(x_{0}, y_{0}\right)$

$\therefore \lim _{x \rightarrow x_{0}} f\left(x, y_{0}\right)=\lim _{y \rightarrow y_{0}} f\left(x_{0}, y\right)=f\left(x_{0}, y_{0}\right)$
...
$\Rightarrow=\ln _{n \rightarrow \infty} \sqrt[n]{|a n|}=\lim _{n \rightarrow \infty} \sqrt[n]{(-1)^{n}\left(1-\frac{1}{n}\right)^{n^{2}}}=\lim _{n \rightarrow \infty}\left(1-\frac{1}{n}\right)^{n}=e^{-1}<1$

$\Rightarrow$ converges absolutely

(2) $\sum_{n=1}^{\infty}(-1)^{n} e^{-\frac{1}{n}}$

$\Rightarrow \lim _{n \rightarrow \infty} e^{-\frac{1}{n}}=e^{0}=1 \neq 0 \Rightarrow$ diverges.

(3) $\sum_{n=0019}^{\infty}(-1)^{n} \frac{1}{\sqrt{n^{2}-2019 n+1}}$

$\Rightarrow$ For $\sum_{n=019}^{\infty} \frac{1}{\sqrt{n^{2}-2019 n+1}}, \lim _{n \rightarrow \infty} \frac{\frac{1}{\sqrt{n^{2}-2019 n+1}}}{\frac{1}{n}}=1, \sum \frac{1}{n}$ diverges $\Rightarrow$ diverges.
...
(2) when $x=\frac{1}{2} \quad \sum_{n=0}^{\infty} \frac{(-1)^{n+1}}{\sqrt{n^{2}+n+1}}$ converges conditionally since $\left\{\begin{array}{l}\frac{1}{\sqrt{n^{2}+n+1}} \geq 0 \\ \frac{1}{n}, \lim _{n \rightarrow 0} \frac{1}{\sqrt{n^{2}+n+1}} 0\end{array}\right.$

$\lim _{n \rightarrow \infty} \frac{\sqrt{n^{2}+n+1}}{\frac{1}{n}}=1, \sum \frac{1}{n}$ diverges.

$\Rightarrow \sum \frac{1}{\sqrt{n^{2}+n+1}}$ diverges.

when $x=-\frac{1}{2}, \sum_{n=0}^{\infty} \frac{(-1)^{n+} \cdot(-1)^{n}}{\sqrt{n^{2}+n+1}}=\sum_{n=0}^{\infty} \frac{-1}{\sqrt{n^{2}+n+1}}$ diverges since $\lim _{n \rightarrow \infty} \frac{1}{\sqrt{n^{2}+n+1}} \frac{1}{n}=1, \sum \frac{1}{n}$ diverges.
...
$\Rightarrow \lim _{(x, y) \rightarrow(0,0)} f(x, y)=\lim _{(x, y) \rightarrow(0,0)} \frac{\sin \left(x^{3}+y^{3}\right)}{x^{2}+y^{2}}=\lim _{(x, y) \rightarrow(0,0)} \frac{\sin \left(x^{3}+y^{3}\right)}{x^{3}+y^{3}} \cdot \frac{x^{3}+y^{3}}{x^{2}+y^{2}}=\lim _{(x, y) \rightarrow(0,0)} \frac{x^{3}+y^{3}}{x^{2}+y^{2}}$

$$
=\lim _{r \rightarrow 0} \frac{r^{3} \cos ^{3} \theta+r^{2} \sin ^{3} \theta}{r^{2}}=\lim _{r \rightarrow 0} r\left(\cos ^{3} \theta+\sin ^{3} \theta\right)=0 .
$$
...
$$
\lim _{(x, y) \rightarrow(0,0)}(|x|+|y|)=0
$$

$\Rightarrow \lim _{(x, y) \rightarrow(0,0)}\left|\frac{x^{3}+y^{3}}{x^{2}+y^{2}}\right|=0 \Rightarrow \lim _{(x, y) \rightarrow(0,0)} \frac{x^{3}+y^{3}}{x^{2}+y^{2}}=0$

$\Rightarrow \lim _{f(x, y)} f(x)=0=f(0,0)$
