...
& =\lim\limits_{x \rightarrow 0} \frac{3\left(2 x-\frac{(2 x)^{3}}{3!}+0\left(x^{3}\right)\right)-2\left(3 x-\frac{(3 x)^{3}}{3!}+0\left(x^{3}\right)\right)}{6 x^{3}+x^{4}} \\
...
& \begin{aligned}
\lim\limits_{n \rightarrow \infty}\left(\frac{a^{n}}{n^{2}}\right)^{\frac{1}{n}} & =h_{n \rightarrow \infty} \frac{a}{\left(n^{\frac{1}{n}}\right)^{2}}, h_{n \rightarrow \infty}\left(\frac{2 a^{n}}{n}\right)^{\frac{1}{n}}=l_{n \rightarrow \infty} \frac{2^{\frac{1}{n}} \cdot a}{n^{\frac{1}{n}}}=a . \\
& =a
\end{aligned} \\
