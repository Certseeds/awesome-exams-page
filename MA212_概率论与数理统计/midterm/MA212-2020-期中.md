...
Suppose random variables $X, Y$ follow Poisson distribution $X \sim P\left(\lambda_{1}\right), Y \sim P\left(\lambda_{2}\right)$. Furthermore $X$ and $Y$ are independent.
