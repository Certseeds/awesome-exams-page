...
$$
\begin{aligned}
F_{Y}(y) & =P(Y \leq y) =P(X^{2} \leq y) =P(0 \leq X<\sqrt{y}) \\
...
\frac{1-e^{-u}}{1-e^{-1}}, & 0 \leq u<1, \\
1, & u \geq 1 .\end{cases} \\
& F_{Y}(u) =\int_{-\infty}^{u} f_{Y}(y) d y= \begin{cases}0, & u<0 \\
1-e^{-u}, & u \geq 0 .\end{cases}
\end{aligned}
$$
...
\{\begin{array}{lc}
0, & u<0 \\
\frac{\left(1-e^{-u}\right) ^{2}}{1-e^{-1}}, & 0 \leq u<1, \\
1-e^{-u}, & u \geq 1
\end{array}
\right.
$$
