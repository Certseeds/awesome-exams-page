...
设 $A_{1}, A_{2}, A_{3}$ 是样本空间的一个划分且 $P\left(A_{1}\right) =0.2, P\left(A_{2}\right) =0.5, P\left(B \mid A_{1}\right) =0.1$ , $P\left(B \mid A_{2}\right) =0.4, P\left(B \mid A_{3}\right) =0.7$ .那么 $P\left(A_{3} \mid B\right) =$ $\underline{\quad\quad\quad}$
