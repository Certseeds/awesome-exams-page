...
Let the density function of $X$ be $f(x) =\left\{\begin{array}{ll}kx^{2}, & 0 \leq x<3, \\ 0, & \text {otherwise,}\end{array}\right.$

Let $Y= \begin{cases}2, & X \leq 1, \\ X, & 1<x<2, \\ 1, & X \geq 2 .\end{cases}$
