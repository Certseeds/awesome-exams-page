...
$$
\begin{aligned}
& \text { original }=\lim\limits_{x \rightarrow \infty} e^{x \ln (\frac{x+a}{x-a})}=e^{\lim\limits_{x \rightarrow \infty} x \ln(\frac{x+a}{x-a})} \\
...
$$
\text { max, } \sin t=\frac{1}{2} \Rightarrow t=\frac{\pi}{6} \quad, \theta=\frac{\pi}{3}
$$
...
& \text { original }=\frac{1}{2} \lim\limits_{x \rightarrow 0} \frac{x}{\ln(1+x)} \cdot \frac{3 \sin x+x^{2} \cos \frac{1}{x}}{x} \\
...
& \text { let } x=\sec \theta \text {. } \\
& d x=\sec \theta \tan \theta d \theta \\
& x=\sqrt{2} \quad \theta=\frac{\pi}{4} \\
& x=1 \quad \theta=0 \\
& \text { original }=\int_{0}^{\frac{\pi}{4}} \frac{\sec \theta \tan \theta}{\sec ^{3} \theta \tan \theta} d \theta \\
...
& \text { let } x^{-5}=t \\
& \text { then } \int \frac{1}{x^{6}(x^{5}+4)} d x=-\frac{1}{5} \int \frac{1}{\frac{1}{t}+4} d t=-\frac{1}{5} \int \frac{t}{4 t+1} d t \\
...
& \left.\left.\therefore \text { original }=-\frac{x^{-5}}{20}\right]_{1}^{\infty}+\frac{\ln (x^{-5}+\frac{1}{4})}{80}\right]_{1}^{\infty} \\
...
& \text { let } \frac{3}{4} \tan ^{2} \theta=(x+\frac{1}{2})^{2} \\
& =\int \frac{1}{((x+\frac{1}{2})^{2}+\frac{3}{4})^{2}} d(x+\frac{1}{2}) \quad \text { then } \frac{\sqrt{3}}{2} \tan \theta=(x+\frac{1}{2}) \\
...
& \therefore \text { original }=\frac{4 \sqrt{3}}{9} \arctan (\frac{2}{\sqrt{3}} x+\frac{1}{\sqrt{3}})
+\frac{8}{9} \cdot \frac{x+\frac{1}{2}}{\frac{4}{3}(x+\frac{1}{2})^{2}+1}
+ C
\end{aligned}
$$
