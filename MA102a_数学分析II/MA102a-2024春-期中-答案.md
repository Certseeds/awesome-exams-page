...
取 $S_{i}=\left(\frac{1}{i}, 0\right), t_{i}=\left(\frac{1}{i}, \frac{1}{i}\right)$ ，则 $S_{i} \rightarrow 0(i \rightarrow \infty), t_{i} \rightarrow 0(i \rightarrow \infty)$ ，由 $f\left(S_{i}\right)=0, f\left(t_{i}\right)=\frac{\sqrt{2}}{4}$ 可得上述极限不有在，故 $f$ 于$(0,0)$ 处不可微
