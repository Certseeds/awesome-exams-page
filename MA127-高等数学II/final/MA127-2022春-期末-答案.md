...
$\frac{\partial f}{\partial x}=y^{2} \cdot \frac{-2 x}{\left(x^{2}+y^{2}\right)^{2}} \cdot \cos \left(\frac{1}{x^{2}+y^{2}}\right)$

as a conclusion, $\lim\limits_{(x, y \rightarrow 0,0)} \frac{\partial f}{\partial x} \neq 0$, 不连续
...
原式 $=\lim\limits_{n \rightarrow \infty} n^{3}\left(\frac{2}{n}-\frac{1}{3!} \cdot\left(\frac{2}{n}\right)^{3}+\cdots\right)-2 n^{2}$

$$
=\lim\limits_{n \rightarrow \infty} 2 n^{2}-\frac{8}{3!}-2 n^{2}=-\frac{4}{3}
$$
...
$\nabla$ 有且仅有 $\langle-7,2\rangle$ 或 $\langle 7,-2\rangle$ 所在方向的向量为 $\left.\nabla f\right|_{(3,2)}$
...
+ $\lambda=-1, \Rightarrow y= \pm \frac{2}{\sqrt{5}}, x=\mp \frac{1}{\sqrt{5}}$
