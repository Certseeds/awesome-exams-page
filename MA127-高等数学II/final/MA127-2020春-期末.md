...
Equation $r=2 \sin (\theta)(0 \leq \theta \leq \pi)$ in polar form is a circle of radius 1 centered at $(0,1)$

### 1-2

If $f(x, y)=\sin x+\sin y$, then for any direction $u$, the directional derivative of $f(x, y)$ satisfies $-\sqrt{2} \leq \operatorname{Du} f(x, y) \leq \sqrt{2}$
...
Let $R:(x-1)^{2}+y^{2} \leq 1$, then the integral $\iint R f(x, y) d A$ is not equal to
...
Find the absolute maximum and minimum values of $f(x, y)=e^{-x^{2}-y^{2}}\left(x^{2}+2 y^{2}\right)$ on the close disk $x^{2}+y^{2} \leq 4$
