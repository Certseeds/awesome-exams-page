...
若 $\lim\limits_{x \rightarrow 0} \frac{f(x+h^{2})-f(x)}{h^{2}}$ 存在, 则 $f$ 在 $x$ 处连续
...
已知函数 $f$ 在 $\mathbb{R}$ 上连续, 且 $\lim\limits_{x \rightarrow \infty} f(x)=+\infty$.证明: $f$ 在 $\mathbb{R}$ 上有最小值
