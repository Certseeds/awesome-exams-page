...
求函数 $f(x, y)=\sqrt{1-x^{2}}+\sqrt{y^{2}-1}$ 于点 $D=(\frac{1}{2},-\frac{3}{2})$ 处, 沿方向 $u=(\frac{\sqrt{3}}{2}, \frac{1}{2})$ 的方向导数 $\frac{\partial f}{\partial u}(p)$
...
计算曲线 $x=a \cos t, y=b \sin t, z=0$ 的曲率, 其中 $0<b<a, 0 \leq t \leq 2 \pi$, 并指出曲率的最大值与最小值
