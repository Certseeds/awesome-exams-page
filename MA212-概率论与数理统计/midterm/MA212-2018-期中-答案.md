...
$P(Y=1) =1-P(Y=0) =1-(\frac{2}{3})^{3}=\frac{19}{27} \quad$
...
$P(3<X<4) =\int_{3}^{4} \lambda e^{-\lambda x} dx=e^{-3 \lambda}-e^{-4 \lambda} \quad$

$P(X>2) =\int_{2}^{\infty} \lambda e^{-\lambda x} dx=e^{-2 \lambda}$
...
(2) $\int_{0}^{1} \int_{x^{2}}^{x} cx^{2}y \, dy \, dx=\int_{0}^{1} \frac{c}{2}x^{2}(x^{2}-x^{4}) \, dx=\frac{c}{10}-\frac{c}{14}=\frac{3}{70}$

$\frac{c}{35}=\frac{3}{70} \Rightarrow c = \frac{3}{2}$
...
故当 $0 \leq y < 1$ 时，$f_{X \mid Y}(x \mid y) =\frac{f(x, y)}{f_{Y}(y)}=\frac{1}{2(1-y)} \quad 0 \leq x \leq 2$

## 八

(1) $P(Y \leq 1) =P(Y=1) =P(X = 2) =\int_{2}^{3} \frac{1}{9} x^{2} d x=\frac{19}{27}, x \in (1,2)$

$P(Y \leq x) =P(Y \leq 1) +P(1<Y<x) =\frac{19}{27}+\int_{1}^{x} \frac{1}{9} t^{2} d t=\frac{19}{27}+\frac{1}{27}(x^{3}-1) =\frac{1}{27} x^{3}+\frac{2}{3}, y \geq 2$

$P(Y \leq y) =\frac{26}{27}+P(X \leq 1) =1$
