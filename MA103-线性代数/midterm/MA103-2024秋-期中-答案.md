...
& \text{and} \quad R(A)+R(B) \geq R(A+B) \\
& \text { let } B=I-A \\
& R(A)+R(I-A) \geq R(I)=n
\end{aligned}
$$
...
\left[
\begin{array}{lll}
1\text{(or maybe 3, the pdf is too blurry)} & 1 & -2 \\
1 & 1 & -1 \\
2 & 1 & -1
\end{array}
\right]
...
\Rightarrow A(B_{1}+B_{2})=A B_{1}+A B_{2} \quad \text { verify addition and scalar multiplication closure } \\
A(k B_{1})=k(A B_{1})
\end{gathered}
$$
...
& \text { similarly } k_{s+1}, \cdots k_n=0 . \\
& \Rightarrow \text { linearly independent } \rightarrow \text { is a basis. }
\end{aligned}
$$
